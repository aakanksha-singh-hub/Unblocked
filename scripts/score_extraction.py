...
def main() -> int:
    ...
    ap.add_argument("--a", type=Path, default=Path("data/corpus/LABELLED_annotator_a_round1.csv"))
    ap.add_argument("--b", type=Path, default=Path("data/corpus/LABELLED_annotator_b_round1.csv"))
